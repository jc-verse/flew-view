...
export const formHeads = [
  ...
  },
  {
    ...
    id: '',
    required: false,
    params: { ph: '', genre: 'checkbox', type: '', max: 20 },
  },
  {
    label: '学校咨询',
    code: 'isConsulting',
...
export const centerHeads = {
  ...
  id: '',
  required: true,
  params: { ph: '例：45/45 ，4/4，A*A*A*A*', genre: 'input', type: 'text', max: 20 },
}
...
export const lastHeads = [
  ...
  },
  {
    ...
    id: '',
    required: false,
    params: { ph: '确认录取后请填写', genre: 'input', type: 'text', max: 20 },
  },
]
