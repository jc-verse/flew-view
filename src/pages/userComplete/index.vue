    ...
    <scroll-box>
      <div class="userInfo">
        ...
        <div class="bottom">
            ...
            <div slot="right_list">
              <template v-if="systemImgList.length">
                <div
                  ...
                  v-for="(ite, ind) in systemImgList"
                  :key="ind"
                >
          ...
          <form-item-box
            v-for="(option, ind) in bottomHeads"
            :key="ind"
            :ite="option"
            :show-b="ind + 1 === bottomHeads.length"
          >
            <template v-if="option.code === 'competitionExperience'">
              <EditGame
                ref="editGame"
                className="competitionExperience"
                :formData="showDetailFn"
                @editGameFn="changeFn"
              >
        ...
        <div class="center">
          <form-item-box
            v-for="(ite, ind) in lastHeads"
            :key="ind"
            :ite="ite"
            :show-b="ind + 1 === lastHeads.length"
          >
            <form-item :formData="formData" :headInit="ite" @change="changeFn"></form-item>
          </form-item-box>
        </div>
