<template>
  <div class="group_info_item" :style="{ background: cardStatu.bgColor }">
    ...
    >
      <template slot="right">
        <div class="btn_box">
          <div
            class="blue"
            v-if="cardStatu.showInfo.includes(4)"
            @click="clickBuoy(4)"
            >退出组队</div
          >
          <div
            class="blue"
            v-if="cardStatu.showInfo.includes(5)"
            @click="clickBuoy(5)"
            >完成</div
          >
          <div
            class=""
            v-if="cardStatu.showInfo.includes(6)"
            @click="clickBuoy(6)"
            >停止组队</div
          >
          <div
            class=""
            v-if="cardStatu.showInfo.includes(7)"
            @click="clickBuoy(7)"
            >开启组队</div
          >
          <div
            class=""
            v-if="cardStatu.showInfo.includes(12)"
            @click="clickBuoy(12)"
            >退出</div
          >
    ...
    <div class="content">
      ...
      <join-list
        v-if="cardStatu.showPhone || cardStatu.showMobile"
        title="联系方式"
        type="diy"
      >
