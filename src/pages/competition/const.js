...
export const list = [
  ...
  { id: '6', iconUrl: require('@/static/img1/icon_6.png'), title: '艺术',         subhead: 'Art',                      styles:{background: '#8ACFDC'} },
  { id: '7', iconUrl: require('@/static/img1/icon_7.png'), title: '其他竞赛',      subhead: 'Other Competitions',      styles:{background: '#ACA5E3'} },
  { id: '8', iconUrl: require('@/static/img1/icon_8.png'), title: '自主发起活动',  subhead: 'Other Competitions',      styles:{background: '#76AFE7'} },
]