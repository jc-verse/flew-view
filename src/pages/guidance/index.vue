      ...
      >
        <template #content>
          <div class="tip_content">
            ...
            <p
              >本程序学术帮助、学校咨询所涉及到的服务，只代表服务提供者个人的观点和见解与本程序无关。我们会尽力做好服务提供者的筛选,做到客观、公正、有内涵，对大家有帮助。</p
            >
            <p
              >由于是学生群体运营，有很多不足之处。请联系客服提出宝贵意见，让我们能真正帮助到大家，再次感谢！</p
            >
          </div>
        </template>
        <template #btn>
...
<script>
  ...
  import { setStorage, closeLogin } from '@/common/utils';
