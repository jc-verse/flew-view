<template>
  <DiyPopup @popupclosed="popupclosed" ref="diyPopup" popupTitle="经历" :styles="{ top: 'auto' }">
    ...
    <div class="center" style="padding: 0 40rpx" slot="content">
      <form-item-box
        v-for="(ite, indx) in matchlist"
        :key="indx"
        :ite="ite"
        :show-b="indx + 1 === matchlist.length"
        :formData="{}"
      >
          ...
          <template slot="upload">
            <div class="box" v-if="forms.authUrl">
              ...
              <i
                ...
                class="iconfont iconshanchu icon"
        ...
        matchlist: [
          {
            ...
            id: '',
            required: true,
            params: { ph: '请填写比赛名称', genre: 'input', type: 'text', max: 20 },
          },
          {
            label: '比赛时间',
            code: 'time',
            id: '',
            required: false,
            params: { ph: '请填写比赛时间', genre: 'date', type: 'text', max: 20, fields: 'month' },
          },
          {
            label: '获得奖项',
            code: 'wonAwards',
            id: '',
            required: false,
            params: { ph: '请填写获得奖项', genre: 'input', type: 'text', max: 30 },
          },
          {
            label: '上传认证',
            code: 'authUrl',
