...
export const formHeads = [
  ...
  { label: '学校',   code:'schoolName',id: '' ,required: true,  params: { ph: '请填写学校',    genre:'inputSelect', type: 'text', max: 20 ,candidates:[], tipMsg:'若列表中缺少校名，选择缺省选项后，联系客服添加'  } },
...
export const centerHeads =  { 
  label: '校内成绩', code:'schoolRecord', id: '' ,required: false,  params: { ph: '例：45/45 ，4/4，A*A*A*A*',  genre:'input', type: 'text', max: 20 }
};
